...
<p align="center">
  <img src="/readme/check.png" width="24" title="Fully Responsive"              style="vertical-align: middle; margin-right: 10px;" />Responsive
  <img src="/readme/check.png" width="24" title="Branded Error Pages"           style="vertical-align: middle; margin-right: 10px;" />Branded Error Pages
  <img src="/readme/check.png" width="24" title="Middleware Exception Handling" style="vertical-align: middle; margin-right: 10px;" />Middleware Exception Handling
  <img src="/readme/check.png" width="24" title="Keep Users Informed"           style="vertical-align: middle; margin-right: 10px;" />Fully Customizable
</p>
