...
<p align="center">
  <img src="readme/controller_test.png" title="ExceptionsController compiles the exception & delivers to the front-end" /> &nbsp;
</p>
...
<p align="center">
  <a href="http://rubygems.org/gems/exception_handler" target="_blank">
    <img src="/readme/rubygems.jpg" title="Download Through RubyGems" />
    <br />
  </a>
</p>
